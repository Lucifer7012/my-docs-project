...
- Hardened Game Search regional matching across Korea, Thailand, Vietnam, Japan, Taiwan, Singapore, and Malaysia.
- Removed the rank-only shorthand fallback that could return an unrelated app such as `FGA` for `FGO`.
